    ...
    <div className="p-4 space-y-6">
           ...
           <div className="p-1 animate-in fade-in-50">
              <div className="mb-4 p-3 bg-blue-50 dark:bg-blue-950/20 rounded-lg border border-blue-200 dark:border-blue-800">
                <p className="text-sm text-blue-900 dark:text-blue-100">
                  <strong>📚 Education Section:</strong> Add your educational background including degrees, courses, and institutions.
                </p>
              </div>
      ...
      <div className="flex justify-between pt-4 border-t">
        ...
        <Button onClick={nextStep}>
          {currentStep === steps.length - 1 ? 'Back to Start' : 'Next'} <ArrowRight />
        </Button>
      </div>
    </div>
  );
